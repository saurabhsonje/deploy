...
namespace CodeFirstEFDemo.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,CourseID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,StudentName,CourseID")] Student student)
        {
            if (ModelState.IsValid)
            {
